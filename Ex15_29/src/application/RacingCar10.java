...
public class RacingCar10 extends Application {
    ...
    private void drawScene(GraphicsContext gc) {
        ...
        gc.fillRoundRect(carX, carY + 20, 220, 50, 30, 30); // Main body

        // Front nose
        gc.setFill(Color.DARKRED);
        gc.fillRect(carX - 30, carY + 35, 40, 20); // Front extension

        // Racing stripe
        gc.setFill(Color.BEIGE);
        gc.fillRect(carX + 10, carY + 35, 180, 10); // Middle stripe

        // Cockpit area
        gc.setFill(Color.GOLD);
        gc.fillOval(carX + 60, carY + 10, 60, 40); // Cockpit base

        // Driver's body
        gc.setFill(Color.BLUE);
        gc.fillRect(carX + 75, carY + 20, 30, 30); // Driver's torso

        // Driver's head
        gc.setFill(Color.BEIGE);
        gc.fillOval(carX + 80, carY + 5, 20, 20); // Driver's head

        // Driver's hair
        gc.setFill(Color.BROWN);
        gc.fillArc(carX + 80, carY + 5, 20, 20, 0, 180, ArcType.OPEN);

        // Steering wheel
        gc.setStroke(Color.BLACK);
        gc.setLineWidth(3);
        gc.strokeOval(carX + 90, carY + 25, 20, 20); // Wheel outline
        gc.setFill(Color.BLACK);
        gc.fillOval(carX + 95, carY + 30, 10, 10); // Wheel grip

        // Rear spoiler
        gc.setFill(Color.RED);
        gc.fillPolygon(
            new double[]{carX + 180, carX + 220, carX + 200},
            new double[]{carY + 10, carY + 10, carY + 40},
            3
        ); // Rear wing
        ...
        gc.fillOval(carX + 150, carY + 60, 40, 40); // Rear wheel

        // Wheel rims
        gc.setFill(Color.SILVER);
        gc.fillOval(carX + 25, carY + 65, 30, 30); // Front rim
        gc.fillOval(carX + 155, carY + 65, 30, 30); // Rear rim

        // Decorative center circle on the body
        gc.setFill(Color.YELLOW);
        gc.fillOval(carX + 140, carY + 25, 30, 30); // Side circle
    }
