...
public class RacingCar4 extends Application {
    ...
    private void drawScene(GraphicsContext gc) {
        ...
        gc.fillPolygon(
            new double[]{carX, carX + 100, carX + 85, carX + 15},
            new double[]{carY + 30, carY + 30, carY + 10, carY + 10},
            4
        );
        ...
        gc.fillPolygon(
            new double[]{carX + 20, carX + 80, carX + 70, carX + 30},
            new double[]{carY + 10, carY + 10, carY - 10, carY - 10},
            4
        );
        ...
        gc.fillPolygon(
            new double[]{carX + 85, carX + 100, carX + 95, carX + 80},
            new double[]{carY + 10, carY + 10, carY, carY},
            4
        );

        // Racing stripes
        gc.setFill(Color.ORANGE);
        gc.fillRect(carX + 25, carY + 15, 50, 5);

        // Headlights
        gc.setFill(Color.YELLOW);
        gc.fillOval(carX - 10, carY + 20, 10, 10);
        gc.fillOval(carX - 10, carY + 40, 10, 10);

        // Taillights
        gc.setFill(Color.ORANGE);
        gc.fillOval(carX + 100, carY + 20, 10, 10);
        gc.fillOval(carX + 100, carY + 40, 10, 10);

        // Wheels
        gc.setFill(Color.BLACK);
        gc.fillOval(carX + 10, carY + 50, 20, 20); // Front wheel
        gc.fillOval(carX + 70, carY + 50, 20, 20); // Back wheel

        // Wheel rims
        gc.setFill(Color.SILVER);
        gc.fillOval(carX + 15, carY + 55, 10, 10); // Front rim
        gc.fillOval(carX + 75, carY + 55, 10, 10); // Back rim

        // Racing number/logo
        gc.setFill(Color.WHITE);
        gc.fillText("99", carX + 42, carY + 25); // Racing number
    }
