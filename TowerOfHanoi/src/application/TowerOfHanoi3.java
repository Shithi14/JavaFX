...
public class TowerOfHanoi3 extends Application {
    ...
    private void moveDisk(int from, int to) {
        ...
        PathTransition transition1 = new PathTransition(Duration.seconds(1), path, disk);
        PathTransition transition2 = new PathTransition(Duration.seconds(1), path2, disk);
        PathTransition transition3 = new PathTransition(Duration.seconds(1), path3, disk);
