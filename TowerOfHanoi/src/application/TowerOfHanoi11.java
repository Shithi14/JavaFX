...
public class TowerOfHanoi11 extends Application {
    ...
    public void start(Stage primaryStage) {
    	...
    	dialogPane.lookup(".header-panel").setStyle("-fx-font-size: 22px; -fx-font-weight: bold; -fx-text-fill: #00796b;"); // Header text style
    	...
    	textField.setStyle("-fx-background-color: #351804; -fx-text-fill: WHITE; -fx-font-size: 20px; -fx-border-radius: 5px; -fx-background-radius: 5px;");

    	// Customize buttons (e.g., OK and Cancel)
    	Button okButton = (Button) dialogPane.lookupButton(ButtonType.OK);
    	okButton.setStyle("-fx-background-color: darkgreen; -fx-text-fill: white; -fx-font-size: 20px; -fx-font-weight: bold; -fx-border-radius: 5px; -fx-background-radius: 5px;");

    	Button cancelButton = (Button) dialogPane.lookupButton(ButtonType.CANCEL);
        cancelButton.setStyle("-fx-background-color: #f44336; -fx-text-fill: white; -fx-font-size: 20px; -fx-font-weight: bold; -fx-border-radius: 5px; -fx-background-radius: 5px;");
      ...
      */
        try {
            ...
            if (numDisks <= 0) throw new NumberFormatException("Disks must be greater than zero.");
            ...
            dialogPane1.lookup(".header-panel").setStyle("-fx-font-size: 18px; -fx-font-weight: bold; -fx-text-fill: black;");
    ...
    private void moveDisk(int from, int to) {
        ...
        PathTransition horizontalTransition = new PathTransition(Duration.seconds(1.5), horizontalPath, disk); // Horizontal move
