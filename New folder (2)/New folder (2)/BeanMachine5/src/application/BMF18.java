...
public class BMF18 extends Application {
    ...
    private ArrayList<Circle> drawMachine(Pane pane) {
        ...
        for (int i = 0; i < SLOT_COUNT; i++) {
            ...
            // Set the slot line color
            slot.setStroke(Color.BLACK); // Example: Set the line color to blue

            // Set the slot line width
            slot.setStrokeWidth(3.0); // Example: Set the line width to 2 pixels

            pane.getChildren().add(slot);
        }


        Rectangle base = new Rectangle(slotStartX, slotBottomY, SLOT_WIDTH * (SLOT_COUNT - 1), 15);
