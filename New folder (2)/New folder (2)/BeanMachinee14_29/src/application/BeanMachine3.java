...
public class BeanMachine3 extends Application {
    ...
    private void addBeautifulBackground() {
        // Add a radial gradient background with light green and light yellow
    ...
    private void drawMachine() {
        ...
        // Draw the colorful pegs with increased size
        ...
        for (int row = 0; row < ROWS; row++) {
            for (int col = 0; col <= row; col++) {
                ...
                Circle peg = new Circle(x, y, 10); // Peg size increased to 10
