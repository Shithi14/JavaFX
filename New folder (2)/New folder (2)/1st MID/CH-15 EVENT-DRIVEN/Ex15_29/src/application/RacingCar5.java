...
public class RacingCar5 extends Application {
    ...
    private void drawScene(GraphicsContext gc) {
        // Clear the canvas
        gc.setFill(Color.BLACK); // Dark background for a cyberpunk vibe
        gc.fillRect(0, 0, 800, 600);

        // Neon ground effect
        gc.setFill(Color.CYAN);
        gc.fillRect(0, 550, 800, 10);

        // Car body
        gc.setFill(Color.DEEPSKYBLUE);
        gc.fillPolygon(
            new double[]{carX, carX + 120, carX + 100, carX + 20},
            new double[]{carY + 40, carY + 40, carY + 20, carY + 20},
            4
        );
        ...
        gc.fillPolygon(
            new double[]{carX + 30, carX + 90, carX + 80, carX + 40},
        ...
        gc.fillPolygon(
            new double[]{carX, carX + 20, carX + 30, carX + 10},
            new double[]{carY + 40, carY + 40, carY + 50, carY + 50},
            4
        );
        ...
        gc.setFill(Color.CYAN);
        gc.fillPolygon(
            new double[]{carX + 100, carX + 120, carX + 110, carX + 90},
            new double[]{carY + 20, carY + 20, carY + 10, carY + 10},
            4
        );
        ...
        gc.setFill(Color.CYAN);
        gc.fillOval(carX + 10, carY + 60, 100, 10);

        // Wheels
        gc.setFill(Color.BLACK);
        gc.fillOval(carX + 15, carY + 50, 30, 30); // Front wheel
        gc.fillOval(carX + 75, carY + 50, 30, 30); // Back wheel

        // Wheel rims
        gc.setFill(Color.CYAN);
        gc.fillOval(carX + 22, carY + 57, 15, 15); // Front rim
        gc.fillOval(carX + 82, carY + 57, 15, 15); // Back rim

        // Headlights
        gc.setFill(Color.YELLOW);
        gc.fillRect(carX - 5, carY + 25, 5, 10);

        // Taillights
        gc.setFill(Color.RED);
        gc.fillRect(carX + 115, carY + 25, 5, 10);

        // Racing number
        gc.setFill(Color.WHITE);
        gc.setFont(javafx.scene.text.Font.font("Arial", 18));
        gc.fillText("X1", carX + 45, carY + 25);
    }
