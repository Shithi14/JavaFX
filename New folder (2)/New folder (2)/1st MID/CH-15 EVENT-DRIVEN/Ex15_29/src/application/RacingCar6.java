...
public class RacingCar6 extends Application {
    ...
    private void drawScene(GraphicsContext gc) {
        ...
        gc.fillOval(carX + 30, carY + 15, 60, 30);

        // Driver
        gc.setFill(Color.SKYBLUE);
        gc.fillOval(carX + 50, carY + 20, 20, 20); // Head
        gc.setFill(Color.RED);
        gc.fillRect(carX + 50, carY + 35, 20, 15); // Body
        gc.setFill(Color.WHITE);
        gc.strokeLine(carX + 50, carY + 35, carX + 40, carY + 45); // Left arm
        gc.strokeLine(carX + 70, carY + 35, carX + 80, carY + 45); // Right arm

        // Wheels
        gc.setFill(Color.BLACK);
        gc.fillOval(carX + 10, carY + 60, 30, 30); // Front wheel
        gc.fillOval(carX + 80, carY + 60, 30, 30); // Back wheel

        // Wheel rims
        gc.setFill(Color.GRAY);
        gc.fillOval(carX + 17, carY + 67, 15, 15); // Front rim
        gc.fillOval(carX + 87, carY + 67, 15, 15); // Back rim

        // Headlights
        gc.setFill(Color.YELLOW);
        gc.fillOval(carX - 10, carY + 40, 10, 10);

        // Racing stripes
        gc.setFill(Color.WHITE);
        gc.fillRect(carX + 45, carY + 45, 30, 5);

        // Spoiler
        gc.setFill(Color.DARKRED);
        gc.fillPolygon(
            new double[]{carX + 90, carX + 120, carX + 110, carX + 80},
        ...
        gc.fillText("21", carX + 55, carY + 45);
    }
