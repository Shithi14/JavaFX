...
public class RacingCar3 extends Application {
    ...
    private void drawScene(GraphicsContext gc) {
        ...
        gc.fillPolygon(
            new double[]{carX, carX + 100, carX + 80, carX + 20},
            new double[]{carY + 25, carY + 25, carY + 5, carY + 5},
            4
        );

        // Car spoiler
        gc.setFill(Color.DARKGRAY);
        gc.fillRect(carX + 80, carY - 5, 20, 10);

        // Racing stripes
        gc.setFill(Color.WHITE);
        gc.fillRect(carX + 10, carY + 10, 80, 5);

        // Headlights
        gc.setFill(Color.YELLOW);
        gc.fillOval(carX - 5, carY + 10, 10, 10);

        // Taillights
        gc.setFill(Color.ORANGE);
        gc.fillOval(carX + 95, carY + 10, 10, 10);
        ...
        gc.fillOval(carX + 15, carY + 45, 10, 10); // Front rim
        gc.fillOval(carX + 75, carY + 45, 10, 10); // Back rim

        // Racing number/logo
        gc.setFill(Color.BLACK);
        gc.fillText("7", carX + 45, carY + 30); // Racing number
    }
