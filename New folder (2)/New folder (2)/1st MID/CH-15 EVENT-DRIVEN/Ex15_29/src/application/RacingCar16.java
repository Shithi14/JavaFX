...
public class RacingCar16 extends Application {
    ...
    private void drawScene(GraphicsContext gc) {
        ...
        gc.fillRect(400 - cameraX, 600, 100, 300); // Speed-up zone
        gc.setFill(Color.ORANGE);
        gc.fillRect(1200 - cameraX, 600, 100, 300); // Slow-down zone
        gc.setFill(Color.RED);
        gc.fillRect(2000 - cameraX, 600, 100, 300); // Brake zone
