...
public class BMF7 extends Application {
    ...
    private void dropBallsSequentially(Pane pane) {
        ...
        for (int i = 0; i < ballCount; i++) {
            ...
            delay.setOnFinished(event -> {
                ...
                double finalX = 450 - (slotsCount / 2.0) * SLOT_WIDTH + random.nextInt(slotsCount) * slotWidth + slotWidth / 2;

                int finalSlotIndex = (int) ((finalX - 410 + (slotsCount / 2.0) * SLOT_WIDTH) / SLOT_WIDTH);

                double finalY = 770 - slots[finalSlotIndex] * 20;
                ...
                slots[finalSlotIndex]++; // Increment slot count here for ball placement
